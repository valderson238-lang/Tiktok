        ...
        <div className="max-w-4xl mx-auto text-center space-y-10">
          ...
          <div className="space-y-4">
            ...
            <h2 className="font-display font-extrabold text-4xl md:text-6xl text-white tracking-tight leading-tight">
              A Escolha é Sua:<br />
              <span className="bg-gradient-to-r from-brand-pink via-white to-brand-cyan bg-clip-text text-transparent italic pe-6 inline-block"
">Assistir ou Construir?</span>
            </h2>
